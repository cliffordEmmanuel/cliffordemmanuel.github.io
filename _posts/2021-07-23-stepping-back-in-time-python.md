...
- `n` can refer to number of steps. And also takes **+** or **-** for eg: - `'2021-01-23'+ pd.offsets.MonthEnd(+2)` returns the last day of the March 2021 - `'2021-01-23'+ pd.offsets.MonthEnd(12)` returns the last day of the November 2020  
  <br>
