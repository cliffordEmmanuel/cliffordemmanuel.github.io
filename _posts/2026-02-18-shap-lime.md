...
1. **LIME:** Ribeiro, M. T., Singh, S., & Guestrin, C. (2016). *"Why Should I Trust You?": Explaining the Predictions of Any Classifier*. In Proceedings of the 22nd ACM SIGKDD International Conference on Knowledge Discovery and Data Mining (KDD '16). [arXiv:1602.04938](https://arxiv.org/abs/1602.04938)
2. **SHAP:** Lundberg, S. M., & Lee, S.-I. (2017). *A Unified Approach to Interpreting Model Predictions*. In Advances in Neural Information Processing Systems 30 (NeurIPS 2017). [arXiv:1705.07874](https://arxiv.org/abs/1705.07874)
3. **Interpretable Machine Learning:** Molnar, C. (2022). *Interpretable Machine Learning: A Guide for Making Black Box Models Explainable* (2nd ed.). [Online Book](https://christophm.github.io/interpretable-ml-book/)
